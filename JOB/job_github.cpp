...
int main(){
    ...
    cout << "\n3.2\tO somatorio é de " << soma << "\n\tO numero de termos somados eh de " << c2;
    double mi = sqrt(soma/c2);
    cout << "\n\tO desvio padrao das horas dormidas eh de " << mi << ";"<<endl;
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    c=0;
    int none=0,doente=0, upboa=0, downboa=0, upruim=0, downruim=0;
    string PressureUP, PressureDOWN;
    arquivo.seekg(0);
    while(!arquivo.eof()){
        getline(arquivo,Person,',');//1
        getline(arquivo,Gender,',');//2
        ...
        if(c>=2){
            if(Disorder=="None"){
                none++;
                upboa+= stof(PressureUP);
                downboa+= stof(PressureDOWN);
            }
            else{
                doente++;
                upruim+= stof(PressureUP);
                downruim+= stof(PressureDOWN);
            }
        }
    }
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    c=0;
    int Nob=0,Nn=0,Nov=0;
    float squalidadeNormal=0,squalidadeOver=0,squalidadeObese=0;
    arquivo.seekg(0);
    while(!arquivo.eof()){
        getline(arquivo,Person,',');//1
        getline(arquivo,Gender,',');//2
    ...
    c=0;
    int Bo=0;
    int Ni1=0 , Ni2=0, Ni3=0, Ni4=0, Ndi1=0, Ndi2=0, Ndi3=0, Ndi4=0;
    while(!arquivo.eof()){
        getline(arquivo,Person,',');//1
        getline(arquivo,Gender,',');//2
        getline(arquivo,Age,',');//3
